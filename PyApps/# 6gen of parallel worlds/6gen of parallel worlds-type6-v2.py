...
class ParallelWorlds:
    def __init__(self, num_worlds, num_generations):
        ...
        self.decisions = {
            ...
            2: ["Governance", "Decentralization", "Centralization"],
            3: ["Infrastructure", "Public transportation", "Private transportation"],
            4: ["Social equality", "Redistribution", "Meritocracy"],
            5: ["Healthcare", "Universal healthcare", "Private healthcare"],
            6: ["Environmental sustainability", "Renewable energy", "Fossil fuels"]
        }
